    ...
    return (
        <>
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3 mb-0 text-gray-800">Welcome, Pupil...</h1>
            </div>
            <div className="row">
                <Card name="Student Name" value='Bharath' color="primary" />
                <Card name="Standard" value="XII-A" color="success" />
                <Card name="Class Coordinator" value="Mathi" color="info" />
