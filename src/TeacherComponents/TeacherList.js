...
function TeacherList() {
  ...
  let getStudents = async () => {
    try {
      const students = await axios.get("https://63a9bccb7d7edb3ae616b639.mockapi.io/Students");
  ...
  let handleDelete = async (id) => {
    try {
      ...
      if (confirmDelete) {
        await axios.delete(`https://63a9bccb7d7edb3ae616b639.mockapi.io/Students/${id}`);
        getStudents();
      }
    } catch (error) {
      console.log(error);
