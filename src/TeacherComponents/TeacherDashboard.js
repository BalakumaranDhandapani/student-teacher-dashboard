...
function TeacherDashboard() {
    return (
        <>
            ...
            <div className="row">
                <Card name="Teacher Name" value='Mathi' color="primary" />
                <Card name="Co-ordinator for" value="XII-A" color="success" />
                <Card name="Years of Expertise" value="5 Years" color="info" />
                <Card name="Department" value="Physics" color="danger" />
            </div>
            <div className='row'>
