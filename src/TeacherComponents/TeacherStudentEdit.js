...
function TeacherStudentEdit() {
    ...
    let getStudents = async () => {
        try {
            const students = await axios.get(`https://63a9bccb7d7edb3ae616b639.mockapi.io/Students/${params.id}`);
    ...
    const myFormik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                setLoading(true);
                await axios.put(`https://63a9bccb7d7edb3ae616b639.mockapi.io/Students/${params.id}`, values);
                setLoading(false);
